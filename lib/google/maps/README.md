...
```python
from htk.lib.lib.google.maps.utils import Client

# Create client with credentials
client = Client(api_key='your_api_key')

# Or use from settings
client = Client()  # Uses HTK_MAPS_API_KEY from settings
```
...
```python
# settings.py
HTK_MAPS_API_KEY = 'your_api_key'
HTK_MAPS_API_SECRET = 'your_secret'
HTK_MAPS_API_URL = 'https://api.service.com'
```
...
```python
# settings.py
HTK_MAPS_ENABLED = True
HTK_MAPS_API_KEY = 'your_key'
HTK_MAPS_TIMEOUT = 30
HTK_MAPS_RETRIES = 3
```
