...
> HTK Cloud Messaging module

## Purpose

The `cloud_messaging` directory contains cloud messaging-related functionality for HTK applications.
...
```python
from htk.lib/google import cloud_messaging
...
```python
# settings.py
HTK_CLOUD_MESSAGING_ENABLED = True
```
...
class CloudMessagingTestCase(TestCase):
    def setUp(self):
