...
```python
from htk.lib.lib.google.translate.utils import Client

# Create client with credentials
client = Client(api_key='your_api_key')

# Or use from settings
client = Client()  # Uses HTK_TRANSLATE_API_KEY from settings
```
...
```python
# settings.py
HTK_TRANSLATE_API_KEY = 'your_api_key'
HTK_TRANSLATE_API_SECRET = 'your_secret'
HTK_TRANSLATE_API_URL = 'https://api.service.com'
```
...
```python
# settings.py
HTK_TRANSLATE_ENABLED = True
HTK_TRANSLATE_API_KEY = 'your_key'
HTK_TRANSLATE_TIMEOUT = 30
HTK_TRANSLATE_RETRIES = 3
```
