...
```python
from htk.lib.lib.google.gmail.utils import Client

# Create client with credentials
client = Client(api_key='your_api_key')

# Or use from settings
client = Client()  # Uses HTK_GMAIL_API_KEY from settings
```
...
```python
# settings.py
HTK_GMAIL_API_KEY = 'your_api_key'
HTK_GMAIL_API_SECRET = 'your_secret'
HTK_GMAIL_API_URL = 'https://api.service.com'
```
...
HTK_GMAIL_API_KEY = 'your_key'
HTK_GMAIL_TIMEOUT = 30
HTK_GMAIL_RETRIES = 3
```
