...
client = Client()  # Uses HTK_S3_API_KEY from settings
```
...
```python
# settings.py
HTK_S3_API_KEY = 'your_api_key'
HTK_S3_API_SECRET = 'your_secret'
HTK_S3_API_URL = 'https://api.service.com'
```
