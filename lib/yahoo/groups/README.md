...
client = Client()  # Uses HTK_GROUPS_API_KEY from settings
```
...
```python
# settings.py
HTK_GROUPS_API_KEY = 'your_api_key'
HTK_GROUPS_API_SECRET = 'your_secret'
HTK_GROUPS_API_URL = 'https://api.service.com'
```
...
```python
# settings.py
HTK_GROUPS_ENABLED = True
HTK_GROUPS_API_KEY = 'your_key'
HTK_GROUPS_TIMEOUT = 30
HTK_GROUPS_RETRIES = 3
```
