...
client = Client()  # Uses HTK_SPORTS_API_KEY from settings
```
...
```python
# settings.py
HTK_SPORTS_API_KEY = 'your_api_key'
HTK_SPORTS_API_SECRET = 'your_secret'
HTK_SPORTS_API_URL = 'https://api.service.com'
```
...
HTK_SPORTS_API_KEY = 'your_key'
HTK_SPORTS_TIMEOUT = 30
HTK_SPORTS_RETRIES = 3
```
