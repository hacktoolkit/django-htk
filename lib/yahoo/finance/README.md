...
client = Client()  # Uses HTK_FINANCE_API_KEY from settings
```
...
```python
# settings.py
HTK_FINANCE_API_KEY = 'your_api_key'
HTK_FINANCE_API_SECRET = 'your_secret'
HTK_FINANCE_API_URL = 'https://api.service.com'
```
...
```python
# settings.py
HTK_FINANCE_ENABLED = True
HTK_FINANCE_API_KEY = 'your_key'
HTK_FINANCE_TIMEOUT = 30
HTK_FINANCE_RETRIES = 3
```
