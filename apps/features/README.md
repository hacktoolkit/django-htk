...
> Feature flags and feature management system.

## Purpose

The features app provides feature flags, gradual rollouts, A/B testing, and user-based feature control.

## Quick Start

```python
from htk.apps.features.models import *
...
| Component | Purpose |
|-----------|---------|
| **Models** | Feature, FeatureFlag, UserFeatureAccess models |
...
|----------|--------|---------|
| `/api/features/` | GET | List items |
| `/api/features/` | POST | Create item |
| `/api/features/{id}/` | GET | Get item details |
| `/api/features/{id}/` | PATCH | Update item |
| `/api/features/{id}/` | DELETE | Delete item |

## Configuration

```python
# settings.py
HTK_FEATURES_ENABLED = True
