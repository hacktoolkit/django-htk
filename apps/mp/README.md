...
> Marketplace and seller management system.

## Purpose

The mp app provides seller profiles, product listings, transactions, and marketplace features.

## Quick Start

```python
from htk.apps.mp.models import *
...
| Component | Purpose |
|-----------|---------|
| **Models** | Seller, MarketplaceProduct, Transaction models |
...
|----------|--------|---------|
| `/api/mp/` | GET | List items |
| `/api/mp/` | POST | Create item |
| `/api/mp/{id}/` | GET | Get item details |
| `/api/mp/{id}/` | PATCH | Update item |
| `/api/mp/{id}/` | DELETE | Delete item |
