...
> Mobile app support and mobile-specific features.

## Purpose

The mobile app provides mobile device detection, app versioning, push notifications, and mobile optimization.

## Quick Start

```python
from htk.apps.mobile.models import *
...
| Component | Purpose |
|-----------|---------|
| **Models** | MobileDevice, AppVersion models |
...
|----------|--------|---------|
| `/api/mobile/` | GET | List items |
| `/api/mobile/` | POST | Create item |
| `/api/mobile/{id}/` | GET | Get item details |
| `/api/mobile/{id}/` | PATCH | Update item |
| `/api/mobile/{id}/` | DELETE | Delete item |

## Configuration

```python
# settings.py
HTK_MOBILE_ENABLED = True
