...
```python
from htk.apps.mobile.constants import HTK_SETTING_NAME
...
```python
from htk.apps.mobile.constants import SomeEnum
...
```python
from htk.apps.mobile.constants import LOOKUP_TABLE
...
from htk.apps.mobile.constants import CONSTANT_NAME

# Or import directly from sub-module
from htk.apps.mobile.constants.general import CONSTANT_NAME
```

### Access Enum Values

```python
from htk.apps.mobile.constants import StatusEnum
...
```python
from htk.apps.mobile.constants import LOOKUP_DATA
