...
The customers app manages customer profiles, company information, contact details, and customer relationships.
...
| Component | Purpose |
|-----------|---------|
| **Models** | Customer, CompanyInfo, ContactPerson models |
...
|----------|--------|---------|
| `/api/customers/` | GET | List items |
| `/api/customers/` | POST | Create item |
| `/api/customers/{id}/` | GET | Get item details |
| `/api/customers/{id}/` | PATCH | Update item |
| `/api/customers/{id}/` | DELETE | Delete item |

## Configuration

```python
# settings.py
HTK_CUSTOMERS_ENABLED = True
