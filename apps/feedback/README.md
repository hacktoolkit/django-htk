...
> User feedback and rating collection system.

## Purpose

The feedback app collects user feedback, ratings, reviews, and feature requests with analytics.

## Quick Start

```python
from htk.apps.feedback.models import *
...
| Component | Purpose |
|-----------|---------|
| **Models** | Feedback, Rating, FeedbackCategory models |
...
|----------|--------|---------|
| `/api/feedback/` | GET | List items |
| `/api/feedback/` | POST | Create item |
| `/api/feedback/{id}/` | GET | Get item details |
| `/api/feedback/{id}/` | PATCH | Update item |
| `/api/feedback/{id}/` | DELETE | Delete item |

## Configuration

```python
# settings.py
HTK_FEEDBACK_ENABLED = True
