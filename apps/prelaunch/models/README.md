...
The `models` directory contains models-related functionality for HTK applications.
...
```python
from htk.apps/prelaunch import models
...
```python
# settings.py
HTK_MODELS_ENABLED = True
```

## Related Modules

- Parent: `htk.apps.prelaunch` if depth > 1
