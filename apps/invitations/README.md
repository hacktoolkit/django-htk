...
> User invitation and acceptance system.

## Purpose

The invitations app manages user invitations, acceptance workflows, and invitation tracking.

## Quick Start

```python
from htk.apps.invitations.models import *
...
| Component | Purpose |
|-----------|---------|
| **Models** | Invitation, InvitationCode models |
...
|----------|--------|---------|
| `/api/invitations/` | GET | List items |
| `/api/invitations/` | POST | Create item |
| `/api/invitations/{id}/` | GET | Get item details |
| `/api/invitations/{id}/` | PATCH | Update item |
| `/api/invitations/{id}/` | DELETE | Delete item |

## Configuration

```python
# settings.py
HTK_INVITATIONS_ENABLED = True
