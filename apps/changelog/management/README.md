...
> HTK Management module

## Purpose

The `management` directory contains management-related functionality for HTK applications.
...
```python
from htk.apps/changelog import management
...
```python
# settings.py
HTK_MANAGEMENT_ENABLED = True
```

## Related Modules

- Parent: `htk.apps.changelog` if depth > 1
