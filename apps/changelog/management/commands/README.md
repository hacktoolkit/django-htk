...
The `commands` directory contains commands-related functionality for HTK applications.
...
```python
from htk.apps/changelog/management import commands
...
```python
# settings.py
HTK_COMMANDS_ENABLED = True
```

## Related Modules

- Parent: `htk.apps.changelog.management` if depth > 1
