...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forum.last_message'
        db.add_column('forums_forum', 'last_message',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forums.ForumMessage'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forum.last_message'
        db.delete_column('forums_forum', 'last_message_id')
    ...
    models = {
        ...
        'forums.forum': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['forums.ForumMessage']", 'null': 'True'}),
