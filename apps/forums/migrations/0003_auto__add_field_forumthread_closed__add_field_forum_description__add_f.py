...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForumThread.closed'
        db.add_column('forums_forumthread', 'closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Forum.description'
        db.add_column('forums_forum', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Forum.created'
        db.add_column('forums_forum', 'created',
        ...
        db.add_column('forums_forum', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 2, 25, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ForumThread.closed'
        db.delete_column('forums_forumthread', 'closed')

        # Deleting field 'Forum.description'
        db.delete_column('forums_forum', 'description')

        # Deleting field 'Forum.created'
        db.delete_column('forums_forum', 'created')

        # Deleting field 'Forum.updated'
        db.delete_column('forums_forum', 'updated')
    ...
    models = {
        ...
        'forums.forum': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forums'", 'to': "orm['sites.Site']"}),
