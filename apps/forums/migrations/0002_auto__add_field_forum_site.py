...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forum.site'
        db.add_column('forums_forum', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='forums', to=orm['sites.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forum.site'
        db.delete_column('forums_forum', 'site_id')
