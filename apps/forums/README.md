...
> Discussion forum and Q&A system.

## Purpose

The forums app provides discussion boards, topics, posts, voting, and community moderation.

## Quick Start

```python
from htk.apps.forums.models import *
...
| Component | Purpose |
|-----------|---------|
| **Models** | Forum, Topic, Post models |
...
|----------|--------|---------|
| `/api/forums/` | GET | List items |
| `/api/forums/` | POST | Create item |
| `/api/forums/{id}/` | GET | Get item details |
| `/api/forums/{id}/` | PATCH | Update item |
| `/api/forums/{id}/` | DELETE | Delete item |

## Configuration

```python
# settings.py
HTK_FORUMS_ENABLED = True
