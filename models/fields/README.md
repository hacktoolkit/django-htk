...
The `fields` directory contains fields-related functionality for HTK applications.
...
```python
# settings.py
HTK_FIELDS_ENABLED = True
```

## Related Modules

- Parent: `htk.models` if depth > 1
